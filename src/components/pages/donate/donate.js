            ...
            <Header image={headerImage}
                ...
                <Container>
                  <Column style={{paddingRight: "7vw", fontSize: "14pt", paddingLeft: "3vw"}}>
                    ...
                    <button onClick={() => window.location.href = 'https://buy.stripe.com/eVa6oY3DveUua0ocMM'}>Pay</button>
                      ...
                      <a href="https://buy.stripe.com/eVa6oY3DveUua0ocMM">Hello</a>
                    </FormCard>
                  </Column>
                  <RightColumn>
                    <SideCard />
